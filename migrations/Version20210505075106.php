 ...
 */
final class Version20210505075106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE salle (id INT AUTO_INCREMENT NOT NULL, partie_id INT DEFAULT NULL, avis_id INT DEFAULT NULL, theme_id INT NOT NULL, ville VARCHAR(255) NOT NULL, INDEX IDX_4E977E5CE075F7A4 (partie_id), INDEX IDX_4E977E5C197E709F (avis_id), INDEX IDX_4E977E5C59027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE themes (id INT AUTO_INCREMENT NOT NULL, theme VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
